...
export const messages = {
  ru: {
    ...
    chart: {
      ...
      playDebitPreviewFreeLine: 'Списание: 1 генерация с бесплатного баланса (доступно: {free}).',
      playDebitPreviewPaidLine: 'Списание: 1 генерация с платного баланса (доступно: {paid}).',
      ...
      balancePaid: 'Платный баланс',
      balanceFree: 'Бесплатный баланс',
  ...
  en: {
    ...
    chart: {
      ...
      playDebitPreviewFreeLine: 'Debit: 1 generation from your free balance (available: {free}).',
      playDebitPreviewPaidLine: 'Debit: 1 generation from your paid balance (available: {paid}).',
