...
export const messages = {
  ru: {
    ...
    chart: {
      ...
      labelLayoutHelp: 'Выберите, где показывать название и значение: справа или слева на краю бара.',
      periodDatePositionTitle: 'Расположение даты периода',
      periodDatePositionHelp: 'Выберите, где показывать дату периода на графике.',
      periodDateTop: 'Сверху',
      periodDateBottom: 'Снизу',
      right: 'Справа',
      rightDesc: 'Название и значение друг под другом справа на краю бара',
      left: 'Слева',
      ...
      playDisabledNoGenerations: 'Нет доступных генераций. Пополните баланс.',
      playReminderTitle: 'Перед запуском',
      playReminderText: 'Не забудьте включить запись экрана, чтобы записать ролик.',
      playControlsHiddenNote: 'Во время анимации графика кнопки управления будут скрыты.',
      ...
      generationUnitFew: 'генерации',
      generationUnitMany: 'генераций',
      balancePaid: 'Доступно',
      balanceFree: 'Free',
      adminFreeTopupButton: '+1 free_balance',
      adminFreeTopupLoading: 'Начисляем...',
      topupTarget: 'Пополнить в',
      topupLoadingPackages: 'Загружаем пакеты...',
      topupNoPackages: 'Пакеты пополнения недоступны',
      buy: 'Купить',
      topupStatus: 'Статус оплаты',
      topupHistory: 'Последние пополнения',
      topupLoadingHistory: 'Загружаем историю...',
      errors: {
  ...
  en: {
    ...
    chart: {
      ...
      periodDatePositionTitle: 'Period date position',
      periodDatePositionHelp: 'Choose where to show the period date on the chart.',
      periodDateTop: 'Top',
      periodDateBottom: 'Bottom',
      right: 'Right',
      ...
      playDisabledNoGenerations: 'No generations available. Top up your balance.',
      playReminderTitle: 'Before starting',
      playReminderText: "Don't forget to enable screen recording to capture the video.",
      playControlsHiddenNote: 'Control buttons will be hidden while the chart animation is running.',
      playReminderDone: 'Done',
      playReminderCancel: 'Cancel',
      playDebitInsufficient: 'Not enough generations on your balance.',
      playDebitPreviewFreeLine: '1 generation will be charged from Free. Current remaining: {free}.',
      playDebitPreviewPaidLine: '1 generation will be charged from Available. Current remaining: {paid}.',
      generationsAriaLabel: 'Available generations',
      generationsPurchaseTitle: 'Buy generations',
      generationUnitOne: 'generation',
      generationUnitFew: 'generations',
      generationUnitMany: 'generations',
      balancePaid: 'Available',
      balanceFree: 'Free',
      adminFreeTopupButton: '+1 free_balance',
      adminFreeTopupLoading: 'Adding...',
      topupTarget: 'Top up to',
      topupLoadingPackages: 'Loading packages...',
      topupNoPackages: 'Top up packages unavailable',
      buy: 'Buy',
      topupStatus: 'Payment status',
      topupHistory: 'Recent top ups',
      topupLoadingHistory: 'Loading history...',
      errors: {
